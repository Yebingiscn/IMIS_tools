...
int main()
{
	...
	while (true)
	{
		...
		case 4:
			...
			a = CopyFileA("E:/WeMeet.rar", "C:/Users/Administrator/Desktop/WeMeet.rar", FALSE);
			if (a)
			{
				cout << "复制成功,准备调用解压程序,解压完后请关闭解压程序，以继续" << endl;
				system("C:/Users/Administrator/Desktop/WeMeet.rar");
				cout << "解压完了吗？没有解压请不要回车，回车后会自动打开程序" << endl;
				system("C:/Users/Administrator/Desktop/WeMeet/WeMeet/wemeetapp.exe");
				system("程序已成功打开");
			}
			else
			{
